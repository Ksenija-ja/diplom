...
•	Открыть веб-страницу турфирмы в  браузере, введя адрес http://localhost:8080/
•	Кликнуть по кнопке "Купить"
•	Откроется форма "Оплата по карте"
•	Заполнить поля в форме
•	Кликнуть на кнопку «Продолжить»
Операция  «Купить в кредит»:
•	Открыть веб-страницу турфирмы в  браузере, введя адрес http://localhost:8080/
•	Кликнуть по кнопке "Купить в кредит"
•	Откроется форма "Кредит по данным карты"
•	Заполнить поля в форме
•	Кликнуть на кнопку «Продолжить»
...
Появилось всплывающее окно с сообщением: "Ошибка! Банк отказал в проведении операции".
Негативные сценарии:
•	Оплата по карте  с невалидным номером карты:
1.	Открыть в браузере страницу http://localhost:8080/
2.	Кликнуть по кнопке "Купить"
...
•	Оплата в кредит  с невалидным номером карты:
1.	Открыть в браузере страницу http://localhost:8080/
2.	Кликнуть по кнопке "Купить в кредит "
3.	Ввести в поле "Номер карты" данные: 111111111
4.	Ввести в поле "Месяц" валидные данные
...
Ожидаемый результат:
Появился текст под полем "Номер карты": "Неверный формат".
•	Оплата в кредит с номером  карты равным нулю:
1.	Открыть в браузере страницу http://localhost:8080/
2.	Кликнуть по кнопке "Купить в кредит "
3.	Ввести в поле "Номер карты" данные: 0000 0000 0000 0000
4.	Ввести в поле "Месяц" валидные данные
...
Ожидаемый результат:
Появился текст под полем "Номер карты": "Неверный формат".
•	Оплата в кредит картой с незаполненным значением номера.
1.	Открыть в браузере страницу http://localhost:8080/
2.	Кликнуть по кнопке "Купить в кредит "
3.	Поле "Номер карты" не содержит значений
4.	Ввести в поле "Месяц" валидные данные
...
Ожидаемый результат:
Появился текст под полем "Месяц": "Неверно указан срок действия карты".
•	Оплата картой с незаполненным значением в поле месяца:
1.	Открыть в браузере страницу http://localhost:8080/
2.	Кликнуть по кнопке "Купить"
3.	Ввести в поле "Номер карты" данные: 4444 4444 4444 4441
...
•	Оплата  в кредит с незаполненным значением номера месяца:
1.	Открыть в браузере страницу http://localhost:8080/
2.	Кликнуть по кнопке "Купить в кредит "
3.	Ввести в поле "Номер карты" данные: 4444 4444 4444 4441
...
Ожидаемый результат:
Появился текст под полем "Месяц": "Неверный форматы".
•	Оплата картой с вводом одной цифры в поле "Месяц":
1.	Открыть в браузере страницу http://localhost:8080/
2.	Кликнуть по кнопке "Купить"
3.	Ввести в поле "Номер карты" данные: 4444 4444 4444 4441
...
•	Оплата в  кредит с вводом одной цифры в поле "Месяц":
1.	Открыть в браузере страницу http://localhost:8080/
2.	Кликнуть по кнопке "Купить в кредит "
3.	Ввести в поле "Номер карты" данные: 4444 4444 4444 4441
4.	Ввести в поле "Месяц" одну цифру
...
•	Оплата в кредит картой с истекшим сроком действия в поле "Год":
1.	Открыть в браузере страницу http://localhost:8080/
2.	Кликнуть по кнопке "Купить в кредит "
3.	Ввести в поле "Номер карты" валидные данные: 4444 4444 4444 4441
4.	Ввести в поле "Месяц" валидные данные 
...
•	Оплата в  кредит с незаполненным значением в поле "Год":
1.	Открыть в браузере страницу http://localhost:8080/
2.	Кликнуть по кнопке "Купить в кредит "
3.	Ввести в поле "Номер карты" валидные данные: 4444 4444 4444 4441
4.	Ввести в поле "Месяц" валидные данные 
...
Ожидаемый результат:
Появился текст под полем "Год": "Неверный формат"
•	Оплата картой с одной цифрой в поле "Год":
1.	Открыть в браузере страницу http://localhost:8080/
2.	Кликнуть по кнопке "Купить"
3.	Ввести в поле "Номер карты" валидные данные: 4444 4444 4444 4441
4.	Ввести в поле "Месяц" валидные данные 
...
Ожидаемый результат:
Появился текст под полем "Год": "Неверный формат"
•	Оплата в кредит с одной цифрой в поле "Год":
1.	Открыть в браузере страницу http://localhost:8080/
2.	Кликнуть по кнопке "Купить в кредит "
3.	Ввести в поле "Номер карты" валидные данные: 4444 4444 4444 4441
4.	Ввести в поле "Месяц" валидные данные 
...
Ожидаемый результат:
Появился текст под полем "Год": "Неверный формат"
•	Оплата карты c пустым полем "Владелец":
1.	Открыть в браузере страницу http://localhost:8080/
2.	Кликнуть по кнопке "Купить"
3.	Ввести в поле "Номер карты"  валидные данные: 4444 4444 4444 4441
4.	Ввести в поле "Месяц" валидные данные 
...
•	Оплата в кредит c пустым поле "Владелец":
1.	Открыть в браузере страницу http://localhost:8080/
2.	Кликнуть по кнопке "Купить в кредит "
3.	Ввести в поле "Номер карты"  валидные данные: 4444 4444 4444 4441
4.	Ввести в поле "Месяц" валидные данные 
...
Ожидаемый результат:
Появился текст под полем "Владелец": "Поле обязательно для заполнения"
•	Оплата по карте с заполненными символами кириллицей  в поле "Владелец"
1.	Открыть в браузере страницу http://localhost:8080/
2.	Кликнуть по кнопке "Купить"
3.	Ввести в поле "Номер карты" валидные  данные: 4444 4444 4444 4441
4.	Ввести в поле "Месяц" валидные данные 
...
•	Оплата в кредит со значением в поле "Владелец", заполненным кириллицей
1.	Открыть в браузере страницу http://localhost:8080/
2.	Кликнуть по кнопке "Купить в кредит "
3.	Ввести в поле "Номер карты" валидные  данные: 4444 4444 4444 4441
4.	Ввести в поле "Месяц" валидные данные 
...
Ожидаемый результат:
Появился текст под полем "Владелец": "Неверный формат"
•	Оплата в кредит в поле "Владелец", заполненным цифрами
1.	Открыть в браузере страницу http://localhost:8080/
2.	Кликнуть по кнопке "Купить в кредит "
3.	Ввести в поле "Номер карты" валидные  данные: 4444 4444 4444 4441
4.	Ввести в поле "Месяц" валидные данные 
...
Ожидаемый результат:
Появился текст под полем "Владелец": "Неверный формат"
•	Оплата по карте с заполнением поля Владелец спецсимволами  кроме допустимых (пробел, дефис)
1.	Открыть в браузере страницу http://localhost:8080/
2.	Кликнуть по кнопке "Купить"
3.	Ввести в поле "Номер карты" валидные  данные: 4444 4444 4444 4441
4.	Ввести в поле "Месяц" валидные данные 
...
Ожидаемый результат:
Появился текст под полем "Владелец": "Неверный формат"
•	Оплата в кредит с заполнением поля Владелец спецсимволами кроме допустимых (пробел, дефис)
1.	Открыть в браузере страницу http://localhost:8080/
2.	Кликнуть по кнопке "Купить в кредит "
3.	Ввести в поле "Номер карты" валидные  данные: 4444 4444 4444 4441
4.	Ввести в поле "Месяц" валидные данные 
...
•	Оплата в  кредит с пустым значением в поле "CVC/CVV"
1.	Открыть в браузере страницу http://localhost:8080/
2.	Кликнуть по кнопке "Купить в кредит"
3.	Ввести в поле "Номер карты" валидные данные из 16 цифр: 4444 4444 4444 4441
4.	Ввести в поле "Месяц" валидные данные
...
Ожидаемый результат:
Появился текст под полем "CVC/CVV": "Неверный формат"
•	Оплата  в кредит в поле "CVC/CVV", состоящих из двух цифр
1.	Открыть в браузере страницу http://localhost:8080/
2.	Кликнуть по кнопке "Купить в кредит"
3.	Ввести в поле "Номер карты" валидные данные из 16 цифр: 4444 4444 4444 4441
4.	Ввести в поле "Месяц" валидные данные
...
Ожидаемый результат:
Появился текст под полем "CVC/CVV": "Неверный формат"
•	Оплата по карте со значением в поле "CVC/CVV", состоящим из одной цифры
1.	Открыть в браузере страницу http://localhost:8080/
2.	Кликнуть по кнопке "Купить"
3.	Ввести в поле "Номер карты" валидные данные из 16 цифр: 4444 4444 4444 4441
4.	Ввести в поле "Месяц" валидные данные
